...
setup(
    name='invoicing-pdf-latest',  # * Your package will have this name
    ...
    author='Somesh Basak',  # Your name
    author_email='someshbasak2016@gmail.com',  # Your email
    url='https://github.com/SomeshBasak',  # Homepage of your library (e.g. github or your website)
    keywords=['invoice', 'excel', 'pdf', 'pdf invoices', 'convert excel to pdf'],
